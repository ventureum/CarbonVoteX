...
contract CarbonVoteXBasic is ICarbonVoteXReceiver{
    ...
    // @param namespace the namespace of this CarbonVoteX receiver
    // @param coreAddr the address of CarbonVoteXCore
    ...
    */
    ...
    /**
        @return the namespace of this CarbonVoteReceiver.
    */
    ...
    // @param pollId UUID (hash value) of a poll
    // @param voter address of a voter
    // @return the number of available votes
    ...
    // @return the number of votes for choice "choice" in poll "pollId"
    ...
    // @param voter address of a voter
    // @param choice the choice of the poll
    // @return the number of votes for choice "choice" by "voter" in poll "pollId"
    // typically called by other contracts
